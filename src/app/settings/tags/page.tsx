                ...
                <tr key={row.id} className="border-t">
                  ...
                  <td className="p-2 flex gap-2">
                    {isEditing ? (
                      ...
                      <>
                        <button className="px-2 py-1 border rounded hover:bg-blue-50" onClick={() => startEdit(row)} title="Edit tag" aria-label="Edit tag">
                          <Edit size={18} />
                        </button>
                        <button
                          className="px-2 py-1 border rounded hover:bg-red-50 disabled:opacity-50"
                          disabled={(row.in_use_count ?? 0) > 0}
                          title={(row.in_use_count ?? 0) > 0 ? `Cannot delete — used by ${row.in_use_count} transaction(s)` : "Delete tag"}
